# ECO 1000 | Guided Notes — Ch. 1: What Is Economics?
...
1. Distinguish scarcity from poverty and explain why scarcity is permanent even if poverty is not.
2. Apply at least three of the eight guideposts to a real decision, identifying the opportunity cost and incentive structure involved.
3. Classify an economic statement as positive or normative and name the reasoning pitfall present in a flawed economic argument.
...
|---|---|---|
| Scarcity | Scarcity exists when there is _____ of a resource freely available than people _____. | A resource scarce in your life: |
| Resources | The _____ people use to produce goods and services; may be human, _____, or natural. | A resource you used or consumed today: |
| Rationing | The method by which society _____ scarce resources among competing _____. | Something rationed on your campus: |
| Opportunity cost | The _____ alternative you give up when you make a choice. | Your last choice: you gave up ___ |
| Economizing | Getting a specific _____ at the _____ possible cost. | A purchase where you economized: |
| Marginal analysis | Comparing _____ costs to _____ benefits to make a decision. | A decision you made "one more" of: |
| Ceteris paribus | Latin for "_____" — holds _____ constant while examining one change. | A comparison where only one thing changed: |
| Positive economics | Studies "what _____" — statements that can be proved _____ or _____. | A testable claim from today's news: |
| Normative economics | Makes judgments about "what _____" — statements that _____ be proved true or false. | A policy opinion you hold: |
| Fallacy of composition | Assuming what is true for the _____ is also true for the _____. | True for one person, false for the group: |

---

## Section I — What Is Economics About?

*Cornell two-column — causal chain: scarcity → choice → rationing → competition*

**Connection to prior learning:**
This is lecture one — no prior economics assumed. Scarcity is the foundation every other concept this semester builds on.
...
## Section II — The Eight Guideposts to Economic Thinking
...
|---|---|---|---|
| 1 | Trade-offs | Using scarce resources always has an _____ cost — the _____ alternative foregone. | You're a hospital budget director. You spend $2M on a new MRI machine. What's the opportunity cost? _______ |
| 2 | Purposeful choice | People _____ — they try to get the _____ from limited resources. This is called _____. | You're hiring for a role that pays $60K or $80K. How does purposeful choice predict who applies? _______ |
| 3 | Incentives | ↑ benefit of an action → _____ likely to do it. ↑ cost → _____. Both _____ and _____ incentives matter. | Uber raised surge pricing during a snowstorm in Boston. What happened to driver supply? Why? _______ |
...
## Section III — Positive vs. Normative Economics

*Comparison matrix*

**Connection to Sections I–II:**
The guideposts describe how economists analyze. Positive vs. normative describes *what kind of question* an economist can answer.

| | Positive | Normative |
|---|---|---|
| Asks… | "What _____?" | "What _____ to be?" |
| Can be tested? | _____: can be proved _____ or _____ | _____: reflects _____ judgments |
| Chapter example | _______________________ | _______________________ |
| Your own example | _______________________ | _______________________ |
| Why it matters in policy debates | | |
| **Classify this:** "When the Fed raises interest rates, inflation falls." | Positive / Normative? _____ Justify: _________________________ | |
| **Classify this:** "The Fed should keep interest rates low to support job growth." | Positive / Normative? _____ Justify: _________________________ | |

---

## Section IV — Pitfalls to Avoid in Economic Thinking

*Comparison matrix — 4 pitfalls*

**Connection to Sections I–III:**
Even careful reasoning goes wrong. These four pitfalls are the most common errors in news coverage, textbooks, and policy arguments.

| Pitfall | The error | Pre-filled example | How to avoid it (you fill in) |
|---|---|---|---|
...
Cover your Notes column. Use only your Questions column and the row headers from each matrix.
...
One real-world situation this made me think of: _______________________
...
Which of the four reasoning pitfalls is most likely to trap a policymaker who supports this plan without doing the economic analysis? Explain.
...
Cover the Notes column. Use your Questions column and matrix row headers to quiz yourself — out loud. Repeat daily until the quiz.
