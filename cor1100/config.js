...
//                          finalExamPeriod
//  4. CANVAS block       — all assignment URLs, viva sign-up URL
//  5. TEXTBOOK block     — perusallUrl once Perusall course is set up
//  6. CHAPTERS block     — threads once finalized, Perusall URLs
...
//    All Perusall readings due Wednesday at 11:59 p.m. of each session.
//    MME passages introduced Friday of designated session;
//      due Wednesday of the following CI week.
...
//  url: Perusall assignment link via Canvas — UPDATE each semester
// ================================================================
const CHAPTERS = {

  all: [
    { key: "intro", num: "Intro",      title: "Introduction",                   session: 1,  url: "" },
    { key: "ch1",   num: "Ch. I",      title: "On Self-Interest",               session: 1,  url: "" },
    { key: "ch2",   num: "Ch. II",     title: "On Caring for Others",           session: 1,  url: "" },
    { key: "ch3",   num: "Ch. III",    title: "On Acting for Others",           session: 2,  url: "" },
    { key: "ch4",   num: "Ch. IV",     title: "On Imagination",                 session: 2,  url: "" },
    { key: "ch5",   num: "Ch. V",      title: "On Bettering Our Condition",     session: 2,  url: "" },
    { key: "ch6",   num: "Ch. VI",     title: "On Miseries and Disorders",      session: 4,  url: "" },
    { key: "ch7",   num: "Ch. VII",    title: "On the Healthy Mind",            session: 4,  url: "" },
    { key: "ch8",   num: "Ch. VIII",   title: "On Tranquility and Pleasure",    session: 4,  url: "" },
    { key: "ch9",   num: "Ch. IX",     title: "On Worshipping Wealth",          session: 5,  url: "" },
    { key: "ch10",  num: "Ch. X",      title: "On Friendship",                  session: 5,  url: "" },
    { key: "ch12",  num: "Ch. XII",    title: "On Hatred and Anger",            session: 5,  url: "" },
    { key: "ch13",  num: "Ch. XIII",   title: "On Being Loved",                 session: 7,  url: "" },
    { key: "ch14",  num: "Ch. XIV",    title: "On Loving",                      session: 9,  url: "" },
    { key: "ch15",  num: "Ch. XV",     title: "On Flourishing",                 session: 9,  url: "" },
    { key: "ch16",  num: "Ch. XVI",    title: "On Being Lovely",                session: 9,  url: "" },
    { key: "ch17",  num: "Ch. XVII",   title: "On Seeing Ourselves",            session: 10, url: "" },
    { key: "ch18",  num: "Ch. XVIII",  title: "On Dignity",                     session: 10, url: "" },
    { key: "ch19",  num: "Ch. XIX",    title: "On Equality",                    session: 10, url: "" },
    { key: "ch20",  num: "Ch. XX",     title: "On Choice",                      session: 12, url: "" },
    { key: "ch21",  num: "Ch. XXI",    title: "On Self and Others",             session: 12, url: "" },
    { key: "ch22",  num: "Ch. XXII",   title: "On Perfection",                  session: 12, url: "" },
    { key: "ch23",  num: "Ch. XXIII",  title: "On Wisdom and Virtue",           session: 13, url: "" },
    { key: "ch24",  num: "Ch. XXIV",   title: "On Humility and Beneficence",    session: 13, url: "" },
    { key: "ch25",  num: "Ch. XXV",    title: "On Praise and Praiseworthiness", session: 13, url: "" },
  ],
...
//    All readings and quizzes due Wednesday at 11:59 p.m. of each session.
//    CI 4 always counts. Replaces lowest of CI 1-3 if higher.
//    No quiz in S7.
// ================================================================
const GRADING = {
  ...
  components: [
    ...
    { id: "puzzles",  label: "Puzzles",                 weight: 15,
      note: "8 formative MC quizzes, one per content session (no quiz in S7). Lowest score dropped. Late within one week at 80%. Due Wednesday 11:59 p.m." },
...
//  See CANVAS.mme for individual assignment titles and URLs
// ================================================================
const SOURCE_TEXT = {
...
const CANVAS = {
  ...
  puzzles: [
    { session: 1,  title: "Puzzle 1: Introduction, On Self-Interest, On Caring for Others",                                url: "" },  // UPDATE
    { session: 2,  title: "Puzzle 2: On Acting for Others, On Imagination, On Bettering Our Condition",                    url: "" },  // UPDATE
    { session: 4,  title: "Puzzle 3: On Miseries and Disorders, On the Healthy Mind, On Tranquility and Pleasure",        url: "" },  // UPDATE
    { session: 5,  title: "Puzzle 4: On Worshipping Wealth, On Friendship, On Hatred and Anger",                          url: "" },  // UPDATE
    { session: 9,  title: "Puzzle 5: On Loving, On Flourishing, On Being Lovely",                                         url: "" },  // UPDATE
    { session: 10, title: "Puzzle 6: On Seeing Ourselves, On Dignity, On Equality",                                       url: "" },  // UPDATE
    { session: 12, title: "Puzzle 7: On Choice, On Self and Others, On Perfection",                                       url: "" },  // UPDATE
    { session: 13, title: "Puzzle 8: On Wisdom and Virtue, On Humility and Beneficence, On Praise and Praiseworthiness",  url: "" },  // UPDATE
  ],

  // MME — 4 passages from The Theory of Moral Sentiments
  // Introduced Friday of designated session. Due Wednesday of following CI week.
  // UPDATE: titles and URLs once passages are selected
  mme: [
    { id: 1, session: 3,  introduced: "Fri Sep 18", due: "Wed Oct 7, 11:59 p.m.",  title: "", url: "" },  // UPDATE
    { id: 2, session: 6,  introduced: "Fri Oct 9",  due: "Wed Nov 4, 11:59 p.m.",  title: "", url: "" },  // UPDATE
    { id: 3, session: 9,  introduced: "Fri Oct 23", due: "Wed Nov 18, 11:59 p.m.", title: "", url: "" },  // UPDATE
    { id: 4, session: 11, introduced: "Fri Nov 6",  due: "Wed Dec 2, 11:59 p.m.",  title: "", url: "" },  // UPDATE
  ],
